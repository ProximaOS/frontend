const AppWindow = {
  ...
  create: async function (manifestUrl, options) {
    var existingWindow = this.containerElement.querySelector(
    ...
    if (windowDiv.id !== "homescreen") {
      ...
      resizeButton.addEventListener("click", this.maximize.bind(this, windowId));
  ...
  focus: function (id) {
    ...
    var dockIcon = this.dock.querySelector(
      `[data-manifest-url="${manifestUrl}"]`
    );
