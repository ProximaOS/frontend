const Keyboard = {
  ...
  init: async function () {
    await fetch(`/js/keyboard_layouts/${this.language}/letters.txt`)
      .then(response => response.text())
      .then(function (data) {
        Keyboard.data.letters = data;
      });
    await fetch(`/js/keyboard_layouts/${this.language}/shift.txt`)
      .then(response => response.text())
      .then(function (data) {
        Keyboard.data.shift = data;
      });
    await fetch(`/js/keyboard_layouts/${this.language}/symbols.txt`)
      .then(response => response.text())
      .then(function (data) {
