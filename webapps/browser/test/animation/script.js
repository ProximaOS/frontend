document.addEventListener('mousemove', (e) => {
  ...
  const mouseProgressX = ((mouseX / windowWidth) * 2) - 1;
  const mouseProgressY = ((mouseY / windowHeight) * 2) - 1;
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        if (isGiggly) {
          eyes.src = 'eyes_open.svg';
        } else {
          eyes.src = 'eyes_smiley_open.svg';
        }
        setTimeout(() => {
          eyes.style.transition = '';
          eyes.style.scale = '1 1';
...
function giggle() {
  ...
  mouth.src = 'mouth_smile.svg';
  setTimeout(() => {
    mouth.style.transition = '';
    mouth.style.scale = '1 1';
    mouth.src = 'mouth_open.svg';
    eyes.src = 'eyes_smiley_open.svg';
